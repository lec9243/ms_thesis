...
nPC:
  ...
  %R1_Var = alloca i64, i32 1     ------- test5 74
  store i64 %R1_Arg, i64* %R1_Var ------- test5 75
  %Sp_Var = alloca i64*, i32 1    ------- test5 72
  store i64* %Sp_Arg, i64** %Sp_Var ------- test5 73
  br label %cPy
cPy:
...
cPw:                                           ---- Need to look at this part 
  ...
  %lnQ1 = add i64 %lnQ0, 1 ---------- test5 131
  store i64 %lnQ1, i64* %R3_Var --------- not in test5
  ...
  %lnQc = load i64, i64* %R3_Var --------- not in test5
