...
parseLLVM src1 src2 str1 str2 = do
  ...
  let mds = moduleDefinitions astModule1
...
--  print (show (termsToVertices (transModuleToTerms astModule2)))
  -- let term1 = renaming_text "_left" (head (transTermstoTermIndex (transModuleToTerms astModule1)))
  --     term2 =  renaming_text "_right" (head (transTermstoTermIndex (transModuleToTerms astModule2)))
